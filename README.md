...
| HTML Partials support                  | Basic HTML template support using [Gulp File Include](https://github.com/coderhaoxin/gulp-file-include) to easily divide those big files into more manageable pieces.                                                                                       |
